...
namespace Scroom
{
  namespace Utils
  {
    namespace Detail
    {
      ...
      void assertionFailed(const char* type, const char* expr, const char* function, const char* filename, unsigned int line)
      {
        std::cerr << "PROGRAM DEFECTIVE: " << filename << ":" << line << ": " << type << " " << expr << " violated in "
                  << function;
