...
docker-build = $(Q)docker run -v $$$$(pwd):/home/build/scroom --rm ghcr.io/kees-jan/scroom-build-container:$(1) sh -x -c "D=\$$$$(mktemp -d) && cmake -S /home/build/scroom -B \$$$$D -GNinja && cmake --build \$$$$D -- -k0 && cd \$$$$D && xvfb-run ctest -j \$$$$(nproc) --output-on-failure"
else
